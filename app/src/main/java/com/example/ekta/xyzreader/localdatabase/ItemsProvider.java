...
public class ItemsProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        final String authority = ItemsContractField.CONTENT_AUTHORITY;
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case ITEMS:
                return ItemsContractField.Items.CONTENT_TYPE;
            case ITEMS__ID:
                return ItemsContractField.Items.CONTENT_ITEM_TYPE;
            default:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case ITEMS: {
                ...
                return ItemsContractField.Items.buildItemUri(_id);
            }
            default: {
                throw new UnsupportedOperationException("Unknown uri: " + uri);
            }
    ...
    private SelectionBuilder buildSelection(Uri uri, int match, SelectionBuilder builder) {
        ...
        switch (match) {
            ...
            case ITEMS__ID: {
                ...
                return builder.table(Tables.ITEMS).where(ItemsContractField.Items._ID + "=?", _id);
            }
            default: {
                throw new UnsupportedOperationException("Unknown uri: " + uri);
            }
