...
public class ArticleDetailFragment extends Fragment implements
    ...
    private Date parsePublishedDate() {
        try {
            String date = mCursor.getString(ArticleLoaderReader.QueryforData.PUBLISHED_DATE);
    ...
    private void initViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoaderReader.QueryforData.BODY).replaceAll("(\r\n|\n)", "<br />")));
            String url = mCursor.getString(ArticleLoaderReader.QueryforData.PHOTO_URL);
